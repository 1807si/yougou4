...
<div class="main wid">
    ...
    <!--特卖专区-->
    <div class="temai">
        <div class="title temai-title">
            <p>特卖专区</p>
        </div>
        <div class="temai-wrap wrap women-wrap rel">
            <!--切换按钮-->
            <ol class="tab abs">
                <li class="rel"><a href="#" class="abs">户外馆</a><span class="abs">></span></li>
                <li class="rel"><a href="#" class="abs">运动馆</a><span class="abs">></span></li>
                <li class="rel"><a href="#" class="abs">鞋靴馆</a><span class="abs">></span></li>
                <li class="rel"><a href="#" class="abs">儿童馆</a><span class="abs">></span></li>
                <li class="rel"><a href="#" class="abs">箱包馆</a><span class="abs">></span></li>
            </ol>
            <!--切换的块-->
            <ul class="/static/assets/img-list abs clear">
                <li class="oli">
                    <a href="details.html">
                        <div class="/static/assets/img">
                            <img src="" />
                        </div>
                        <i></i>
                        <p>
                            <a href="details.html" class="desc"></a>
                        </p>
                    </a>
                    <strong class="color">￥</strong><span class="color"></span><em></em>
                </li>
                <li class="oli">
                    <a href="details.html">
                        <div class="/static/assets/img">
            ...
            <ul class="/static/assets/img-list abs clear" style="display: none;">
                <li class="oli">
                    <a href="details.html">
                        <div class="/static/assets/img">
                            <img src="" />
    ...
    <div class="yougou">
        ...
        <div class="women-wrap wrap daogou">
            <!--按钮-->
            <a href="" id="btn1"></a>
            <a href="" id="btn2"></a>
            <div class="brand">
                ...
                <a href="javascript:;">
                    <img src="/static/assets/img/nike.jpg" />
                    耐克
                </a>
                <a href="javascript:;">
                    <img src="/static/assets/img/nike.jpg" />
            ...
            <ul>
                <li>
                    <strong><a href="javascript:;">潮流女鞋</a></strong>
                    <a href="javascript:;">美靴上新</a>
                    <a href="javascript:;">专柜同款</a>
                    <a href="javascript:;">绒里靴</a>
                    <a href="javascript:;">短靴</a>
                    <a href="javascript:;">长靴</a>
